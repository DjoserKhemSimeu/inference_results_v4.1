...
custom_systems['Orin'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="Cortex-A78AE", architecture=CPUArchitecture.aarch64, core_count=4, threads_per_core=1): 1}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=64.34951600000001, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.Orin.value: 1}), numa_conf=None, system_id="Orin")
